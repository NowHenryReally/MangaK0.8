...
declare class LogLine$Type extends MessageType<LogLine> {
    constructor();
 ...
 */
export declare const LogLine: LogLine$Type;
declare class LogFilter$Type extends MessageType<LogFilter> {
    constructor();
 ...
 */
export declare const LogFilter: LogFilter$Type;
/**
 * @generated ServiceType for protobuf service PaperbackLogger
 */
export declare const PaperbackLogger: ServiceType;
export {};
//# sourceMappingURL=PDTLogger.d.ts.map
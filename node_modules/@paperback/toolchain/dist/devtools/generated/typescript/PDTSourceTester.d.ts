...
declare class SourceInstallRequest$Type extends MessageType<SourceInstallRequest> {
    constructor();
 ...
 */
export declare const SourceInstallRequest: SourceInstallRequest$Type;
declare class SourceInstallResponse$Type extends MessageType<SourceInstallResponse> {
    constructor();
 ...
 */
export declare const SourceInstallResponse: SourceInstallResponse$Type;
declare class SearchData$Type extends MessageType<SearchData> {
    constructor();
 ...
 */
export declare const SearchData: SearchData$Type;
declare class TestData$Type extends MessageType<TestData> {
    constructor();
 ...
 */
export declare const TestData: TestData$Type;
declare class SourceTestRequest$Type extends MessageType<SourceTestRequest> {
    constructor();
 ...
 */
export declare const SourceTestRequest: SourceTestRequest$Type;
declare class SourceTestResponse$Type extends MessageType<SourceTestResponse> {
    constructor();
 ...
 */
export declare const SourceTestResponse: SourceTestResponse$Type;
/**
 * @generated ServiceType for protobuf service PaperbackSourceTester
 */
export declare const PaperbackSourceTester: ServiceType;
export {};
//# sourceMappingURL=PDTSourceTester.d.ts.map